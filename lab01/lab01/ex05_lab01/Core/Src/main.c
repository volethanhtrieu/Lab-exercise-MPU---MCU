...
{
    /*
     * Turn all seven segments OFF first.
     *
...
void countdown(int seconds)
{
    while (seconds > 0)
    {
        ...
        /* Keep this value visible for one second */
        HAL_Delay(1000);
...
int main(void)
{
  ...
  while (1){
         ...
         * East-West RED
         */
        HAL_GPIO_WritePin(GPIOA, NS_RED_Pin,
                                          GPIO_PIN_SET);
        HAL_GPIO_WritePin(GPIOA, NS_YELLOW_Pin,
                                          GPIO_PIN_SET);
        HAL_GPIO_WritePin(GPIOA, NS_GREEN_Pin,
                                          GPIO_PIN_RESET);

        HAL_GPIO_WritePin(GPIOA, EW_RED_Pin,
                                          GPIO_PIN_RESET);
        HAL_GPIO_WritePin(GPIOA, EW_YELLOW_Pin,
                                          GPIO_PIN_SET);
        HAL_GPIO_WritePin(GPIOA, EW_GREEN_Pin,
                                          GPIO_PIN_SET);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, NS_RED_Pin|NS_YELLOW_Pin|NS_GREEN_Pin|EW_RED_Pin
                          |EW_YELLOW_Pin|EW_GREEN_Pin, GPIO_PIN_SET);
